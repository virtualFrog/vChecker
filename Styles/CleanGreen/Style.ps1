...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <!-- CustomHTMLClose -->
   <div style='height: 10px; font-size: 10px;'>&nbsp;</div>
   <table width='100%'><tr><td style='font-size:9pt; height: 25px; text-align: center; vertical-align: middle; color: #000000;'>vSphereChecker v$($vCheckVersion) by <a href='http://virtualfrog.wordpress.com' sytle='color: white;'>Dario Doerflinger</a> generated on $($ENV:Computername) on $($Date.ToLongDateString()) at $($Date.ToLongTimeString())</td></tr></table>
   </body>
</html>      
"@
...
$PluginHTML = @"
	<!-- Plugin Start - _TITLE_ -->
      <div style='height: 10px; font-size: 10px;'>&nbsp;</div>
      <a name="_PLUGINID_" />
      <table width='100%' style='padding: 0px; border-collapse: collapse;'><tr><td style='background-color: #6CB82E; border: 1px solid #6CB82E; font-family: Tahoma, sans-serif; font-weight: bold; font-size: 9pt; color: #FFFFFF; text-indent: 10px; height: 30px; vertical-align: middle;'><a  onclick="toggleRow(this);">_TITLE_</td></tr>
