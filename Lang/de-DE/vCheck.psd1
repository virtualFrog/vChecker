...
ConvertFrom-StringData @' 
    setupMsg01  = 
    setupMsg02  = Willkommen beim vSphereCheck Fork von Dario Doerflinger (@virtualFrog)
    setupMsg03  = =================================================
    setupMsg04  = Dies ist das erste mal, das Sie dieses Script starten, oder der Setup-Wizard wurde neu gestarted.
    setupMsg05  =
